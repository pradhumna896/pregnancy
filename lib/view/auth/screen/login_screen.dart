...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void dispose() {
    ...
    _completer?.complete(); // Complete the completer to avoid lingering callbacks
    _focusNode.dispose();
    super.dispose();
  }
  void _cancelTimer() {
                          ...
                          builder: (runMutation, result) {
                            ...
                            return Column(
                              children: [
                                ...
                                /// for previous logic comment this line and mutation and uncomment comment mutation

                                Mutation(
                                  options: MutationOptions(
                                    document: gql(Operations.newLogin),
                                    onCompleted: (data) {
                                      if (data != null) {
                                        SessionManager.setToken(data["loginMobile"]["accessToken"]);

                                        SessionManager.setUserType(data["loginMobile"]["user"]["userType"]);
                                        SessionManager.setUserTypeSwitch(data["loginMobile"]["user"]["userType"]);

                                        SessionManager.setUserId(data["loginMobile"]["user"]["id"].toString());
                                        SessionManager.setUserIdSwitch(data["loginMobile"]["user"]["id"].toString());

                                        SessionManager.setMaternityId(data["loginMobile"]["user"]["maternityId"].toString());
                                        SessionManager.setMaternityIdSwitch(data["loginMobile"]["user"]["maternityId"].toString());

                                        SessionManager.setName(data["loginMobile"]["user"]["name"]);
                                        SessionManager.setNameSwitch(data["loginMobile"]["user"]["name"]);

                                        showSuccessToast(toast, "Login Successfully");
